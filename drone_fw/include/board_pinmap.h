...
/**
 * @file board_pinmap.h
 * @brief Định nghĩa tập trung toàn bộ chân GPIO của hệ thống Drone STM32F103C8T6.
...
// =============================================================================
#define PIN_MOTOR_1         PB3   // F1-DRV (Trước Phải) - TIM2_CH2 (Remap) hoặc Timer ngắt
...
// =============================================================================
#define PIN_SOFT_I2C_SDA    PA9   // Chân dữ liệu SDA (Open-drain, Pull-up ngoài 4.7k)
#define PIN_SOFT_I2C_SCL    PA10  // Chân nhịp clock SCL (Open-drain, Pull-up ngoài 4.7k)
