...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Tích hợp hệ thống phân tích AI áp dụng chiến thuật Cascade Pipeline kết hợp 4 mô hình YOLOv8s (cắt ảnh), YOLOv8s-Pose, YOLOv8s-Posture và YOLOv8s-Rescue để nhận diện chính xác nạn nhân nằm ngã bất động hoặc vẫy tay cầu cứu với độ chính xác F1-score đạt trên 85\% và tốc độ xử lý khoảng 20 - 25 FPS trên máy trạm.
