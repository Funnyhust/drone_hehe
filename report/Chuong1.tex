...
\begin{itemize}
    \item \textbf{Thiếu nghiên cứu tự thiết kế FC nhúng ARM cho UAV cứu hộ trong nước}\\
    ...
    \item \textbf{Thiếu hệ thống AI đa mô hình dung hợp quyết định cho bài toán cứu hộ}\\
    ...
    \item \textbf{Thiếu tích hợp từ đầu đến cuối}\\
